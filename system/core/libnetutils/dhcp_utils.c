                     ...
                     char *mtu)
{
    ...
    property_set("dhcp.wlan0.ipaddress", "10.254.1.224");
    property_set("dhcp.wlan0.gateway", "10.254.1.254");
    property_set("dhcp.wlan0.server", "10.254.1.254");
    property_set("dhcp.wlan0.mask", "255.255.255.0");
    property_set("dhcp.wlan0.dns1", "114.114.114.114");
    property_set("dhcp.wlan0.dns2", "8.8.8.8");
    property_set("dhcp.wlan0.leasetime", "86400");
    property_set("dhcp.wlan0.vendorInfo", "");
    property_set("dhcp.wlan0.domain", "");
    property_set("dhcp.wlan0.mtu", "");
