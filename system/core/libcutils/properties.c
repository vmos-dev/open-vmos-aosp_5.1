...
int property_set(const char *key, const char *value)
{
    ...
    ALOGW("moe_opensrc: property_set 2 : [%s,%s] = %d", key, value, ret);
    return ret;
}
...
int property_set(const char *key, const char *value)
{
    ...
    ALOGW("moe_opensrc: property_set 3 : [%s,%s] = %d", key, value, result);
...
int property_set(const char *key, const char *value)
{
    ALOGW("moe_opensrc: property_set 4 : [%s,%s] = %d", key, value, 0);
