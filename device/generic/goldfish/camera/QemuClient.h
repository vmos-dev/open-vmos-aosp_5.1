...
public:
     ...
     *  NO_ERROR on success, or an appropriate error status on failure.
     */
    status_t queryConnect(const char* devicename);
    ...
    status_t querySetFocus(const char* focusmode, const char*focus_areas);

    status_t querySetFlash(const char* flash);

    status_t getPicture(void** vpicture, size_t w, size_t h, size_t *size);
    /****************************************************************************
...
private:
    ...
    static const char mQueryPicture[];
    /* Set Focus from the camera device. */
    static const char mQueryFocus[];

    /* Set Flash from the camera device. */
    static const char mQueryFlash[];
};
