...
include $(CLEAR_VARS)
LOCAL_MODULE := libc_penetrate
LOCAL_MULTILIB := both
LOCAL_SRC_FILES_arm := bionic/prebuilt/arm/libc_penetrate.a
LOCAL_SRC_FILES_arm64 := bionic/prebuilt/arm64/libc_penetrate.a
...
include $(CLEAR_VARS)
LOCAL_MODULE := libc_penetrate
LOCAL_SRC_FILES := bionic/__a_bionic_hook.cpp
include $(BUILD_STATIC_LIBRARY)
...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := bionic/hkmalloc.cpp
LOCAL_CFLAGS := $(libc_common_cflags) \
    -fvisibility=hidden \
    -DUSE_JEMALLOC \
...
LOCAL_CONLYFLAGS := $(libc_common_conlyflags)
LOCAL_CPPFLAGS := $(libc_common_cppflags)
LOCAL_C_INCLUDES := external/jemalloc/include $(libc_common_c_includes)
...
# ========================================================
# libc_bionic_hookpthraed.a - home-grown C library code
# ========================================================
...
LOCAL_CPPFLAGS := $(libc_common_cppflags)
LOCAL_C_INCLUDES := $(libc_common_c_includes)
LOCAL_MODULE := libc_bionic_hookpthraed
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libc_common_additional_dependencies)
LOCAL_SYSTEM_SHARED_LIBRARIES :=
...
# ========================================================
# libc_dns_hookpthraed.a - modified NetBSD DNS code
# ========================================================
...
LOCAL_CPPFLAGS := $(libc_common_cppflags)
LOCAL_C_INCLUDES := $(libc_common_c_includes)
LOCAL_MODULE := libc_dns_hookpthraed
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libc_common_additional_dependencies)
LOCAL_SYSTEM_SHARED_LIBRARIES :=
...
# ========================================================
# libc_common_hookpthraed.a
# ========================================================

include $(CLEAR_VARS)

LOCAL_CFLAGS := $(libc_common_cflags) -DLIBCLINKERLVM=1 \
    -DUSE_HKMALLOC \

LOCAL_CONLYFLAGS := $(libc_common_conlyflags)
LOCAL_CPPFLAGS := $(libc_common_cppflags)
LOCAL_C_INCLUDES := $(libc_common_c_includes)
LOCAL_MODULE := libc_common_hookpthraed
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libc_common_additional_dependencies)
LOCAL_WHOLE_STATIC_LIBRARIES := \
    libc_bionic_hookpthraed \
    libc_cxa \
    libc_dns_hookpthraed \
    libc_freebsd \
    libc_gdtoa \
    libc_malloc_hookpthraed \
    libc_netbsd \
    libc_openbsd \
    libc_stack_protector \
    libc_syscalls \
...
LOCAL_MODULE := libc_nomalloc_hookpthraed
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libc_common_additional_dependencies)
LOCAL_WHOLE_STATIC_LIBRARIES := libc_common_hookpthraed
LOCAL_SYSTEM_SHARED_LIBRARIES :=
...
# ========================================================
# libc_malloc_hookpthraed.a: the _prefixed_ malloc functions (like dlcalloc).
# ========================================================

include $(CLEAR_VARS)
libc_malloc_src := bionic/hkmalloc.cpp
# libc_common_cflags += 
...
LOCAL_CPPFLAGS := $(libc_common_cppflags)
LOCAL_C_INCLUDES := $(libc_common_c_includes)
LOCAL_MODULE := libc_malloc_hookpthraed
LOCAL_CLANG := $(use_clang)
LOCAL_ADDITIONAL_DEPENDENCIES := $(libc_common_additional_dependencies)
include $(BUILD_STATIC_LIBRARY)
...
LOCAL_WHOLE_STATIC_LIBRARIES := libc_common_hookpthraed
LOCAL_STATIC_LIBRARIES := libc_penetrate
LOCAL_SYSTEM_SHARED_LIBRARIES :=
